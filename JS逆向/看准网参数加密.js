...
!function(e) {
    ...
    ;
    var o, i = !0, c = "0d26511a090df979c015", a = {}, d = [], s = [];
    function p(n) {
        var r = {
                    ...
                    var l = o.MD5 = a.extend({
                        ...
                        _doProcessBlock: function(e, t) {
                            ...
                            var a = this._hash.words
                              ...
                              , C = a[3];
                            k = c(k, O, E, C, o, 7, s[0]),
                            C = c(C, k, O, E, l, 12, s[1]),
                            E = c(E, C, k, O, h, 17, s[2]),
                            O = c(O, E, C, k, p, 22, s[3]),
                            k = c(k, O, E, C, m, 7, s[4]),
                            C = c(C, k, O, E, g, 12, s[5]),
                            E = c(E, C, k, O, v, 17, s[6]),
                            O = c(O, E, C, k, y, 22, s[7]),
                            k = c(k, O, E, C, _, 7, s[8]),
                            C = c(C, k, O, E, b, 12, s[9]),
                            E = c(E, C, k, O, x, 17, s[10]),
                            O = c(O, E, C, k, w, 22, s[11]),
                            k = c(k, O, E, C, M, 7, s[12]),
                            C = c(C, k, O, E, S, 12, s[13]),
                            E = c(E, C, k, O, L, 17, s[14]),
                            k = u(k, O = c(O, E, C, k, T, 22, s[15]), E, C, l, 5, s[16]),
                            C = u(C, k, O, E, v, 9, s[17]),
                            E = u(E, C, k, O, w, 14, s[18]),
                            O = u(O, E, C, k, o, 20, s[19]),
                            k = u(k, O, E, C, g, 5, s[20]),
                            C = u(C, k, O, E, x, 9, s[21]),
                            E = u(E, C, k, O, T, 14, s[22]),
                            O = u(O, E, C, k, m, 20, s[23]),
                            k = u(k, O, E, C, b, 5, s[24]),
                            C = u(C, k, O, E, L, 9, s[25]),
                            E = u(E, C, k, O, p, 14, s[26]),
                            O = u(O, E, C, k, _, 20, s[27]),
                            k = u(k, O, E, C, S, 5, s[28]),
                            C = u(C, k, O, E, h, 9, s[29]),
                            E = u(E, C, k, O, y, 14, s[30]),
                            k = d(k, O = u(O, E, C, k, M, 20, s[31]), E, C, g, 4, s[32]),
                            C = d(C, k, O, E, _, 11, s[33]),
                            E = d(E, C, k, O, w, 16, s[34]),
                            O = d(O, E, C, k, L, 23, s[35]),
                            k = d(k, O, E, C, l, 4, s[36]),
                            C = d(C, k, O, E, m, 11, s[37]),
                            E = d(E, C, k, O, y, 16, s[38]),
                            O = d(O, E, C, k, x, 23, s[39]),
                            k = d(k, O, E, C, S, 4, s[40]),
                            C = d(C, k, O, E, o, 11, s[41]),
                            E = d(E, C, k, O, p, 16, s[42]),
                            O = d(O, E, C, k, v, 23, s[43]),
                            k = d(k, O, E, C, b, 4, s[44]),
                            C = d(C, k, O, E, M, 11, s[45]),
                            E = d(E, C, k, O, T, 16, s[46]),
                            k = f(k, O = d(O, E, C, k, h, 23, s[47]), E, C, o, 6, s[48]),
                            C = f(C, k, O, E, y, 10, s[49]),
                            E = f(E, C, k, O, L, 15, s[50]),
                            O = f(O, E, C, k, g, 21, s[51]),
                            k = f(k, O, E, C, M, 6, s[52]),
                            C = f(C, k, O, E, p, 10, s[53]),
                            E = f(E, C, k, O, x, 15, s[54]),
                            O = f(O, E, C, k, l, 21, s[55]),
                            k = f(k, O, E, C, _, 6, s[56]),
                            C = f(C, k, O, E, T, 10, s[57]),
                            E = f(E, C, k, O, v, 15, s[58]),
                            O = f(O, E, C, k, S, 21, s[59]),
                            k = f(k, O, E, C, m, 6, s[60]),
                            C = f(C, k, O, E, w, 10, s[61]),
                            E = f(E, C, k, O, h, 15, s[62]),
                            O = f(O, E, C, k, b, 21, s[63]),
                            a[0] = a[0] + k | 0,
                            a[1] = a[1] + O | 0,
                            a[2] = a[2] + E | 0,
                            a[3] = a[3] + C | 0
            ...
            n((function(e, t) {
                ...
                function() {
                    ...
                    var u = o.SHA512 = t.extend({
                        ...
                        _doProcessBlock: function(e, t) {
                            for (var n = this._hash.words, r = n[0], i = n[1], a = n[2], o = n[3], s = n[4], u = n[5], d = n[6], f = n[7], h = r.high, p = r.low, m = i.high, g = i.low, v = a.high, y = a.low, _ = o.high, b = o.low, x = s.high, w = s.low, M = u.high, S = u.low, L = d.high, T = d.low, k = f.high, O = f.low, E = h, C = p, D = m, P = g, A = v, I = y, j = _, N = b, Y = x, R = w, z = M, H = S, V = L, B = T, F = k, W = O, G = 0; G < 80; G++) {
                                var U = c[G];
                                if (G < 16)
                                    var q = U.high = 0 | e[t + 2 * G]
                                      , K = U.low = 0 | e[t + 2 * G + 1];
                                else {
                                    var J = c[G - 15]
                                      , Q = J.high
                                      ...
                                      , ce = le.high
                                      , ue = le.low;
                                    q = (q = (q = Z + oe + ((K = $ + se) >>> 0 < $ >>> 0 ? 1 : 0)) + re + ((K += ie) >>> 0 < ie >>> 0 ? 1 : 0)) + ce + ((K += ue) >>> 0 < ue >>> 0 ? 1 : 0),
                                    U.high = q,
                                    U.low = K
                                }
                                var de, fe = Y & z ^ ~Y & V, he = R & H ^ ~R & B, pe = E & D ^ E & A ^ D & A, me = C & P ^ C & I ^ P & I, ge = (E >>> 28 | C << 4) ^ (E << 30 | C >>> 2) ^ (E << 25 | C >>> 7), ve = (C >>> 28 | E << 4) ^ (C << 30 | E >>> 2) ^ (C << 25 | E >>> 7), ye = (Y >>> 14 | R << 18) ^ (Y >>> 18 | R << 14) ^ (Y << 23 | R >>> 9), _e = (R >>> 14 | Y << 18) ^ (R >>> 18 | Y << 14) ^ (R << 23 | Y >>> 9), be = l[G], xe = be.high, we = be.low, Me = F + ye + ((de = W + _e) >>> 0 < W >>> 0 ? 1 : 0), Se = ve + me;
                                F = V,
                                W = B,
                                V = z,
                                B = H,
                                z = Y,
                                H = R,
                                Y = j + (Me = (Me = (Me = Me + fe + ((de += he) >>> 0 < he >>> 0 ? 1 : 0)) + xe + ((de += we) >>> 0 < we >>> 0 ? 1 : 0)) + q + ((de += K) >>> 0 < K >>> 0 ? 1 : 0)) + ((R = N + de | 0) >>> 0 < N >>> 0 ? 1 : 0) | 0,
                                j = A,
                                N = I,
                                A = D,
                                I = P,
                            ...
                            y = a.low = y + I,
                            a.high = v + A + (y >>> 0 < I >>> 0 ? 1 : 0),
                            b = o.low = b + N,
                            o.high = _ + j + (b >>> 0 < N >>> 0 ? 1 : 0),
                            w = s.low = w + R,
                                ...
                                f = 0; f < 5; f++)
                                    for (m = 0; m < 5; m++) {
                                        var O = n[x = f + 5 * m]
                                          ...
                                          , C = d[(f + 1) % 5 + 5 * m]
                                          , D = d[(f + 2) % 5 + 5 * m];
                                        O.high = E.high ^ ~C.high & D.high,
                                        O.low = E.low ^ ~C.low & D.low
                                    }
                                O = n[0];
                                var P = u[s];
                                O.high ^= P.high,
                    ...
                    var t = n
                      ...
                      , h = o.RIPEMD160 = a.extend({
                        ...
                        _doProcessBlock: function(e, t) {
                            ...
                            var a, o, h, b, x, w, M, S, L, T, k, O = this._hash.words, E = d.words, C = f.words, D = s.words, P = l.words, A = c.words, I = u.words;
                            for (w = a = O[0],
                            M = o = O[1],
                            S = h = O[2],
                            L = b = O[3],
                            ...
                            n = 0; n < 80; n += 1)
                                k = a + e[t + D[n]] | 0,
                                k += n < 16 ? p(o, h, b) + E[0] : n < 32 ? m(o, h, b) + E[1] : n < 48 ? g(o, h, b) + E[2] : n < 64 ? v(o, h, b) + E[3] : y(o, h, b) + E[4],
                                k = (k = _(k |= 0, A[n])) + x | 0,
                                a = x,
                                x = b,
                                b = _(h, 10),
                                ...
                                o = k,
                                k = w + e[t + P[n]] | 0,
                                k += n < 16 ? y(M, S, L) + C[0] : n < 32 ? v(M, S, L) + C[1] : n < 48 ? g(M, S, L) + C[2] : n < 64 ? m(M, S, L) + C[3] : p(M, S, L) + C[4],
                                k = (k = _(k |= 0, I[n])) + T | 0,
                                w = T,
                                T = L,
                                L = _(S, 10),
...
;//传入公司名字   位置   城市信息啥的  jiami(t)得到  b kiv
t = {
    data: {
        encCompanyId: "0nx_3g~~",
        positionId: "",
...
function jiemi(data,i){
	var m = aaa("M0uz");
	var n = Object(m.a)(data, {
		iv: i.kiv
	});
	return JSON.parse(n)	
}
//传入   data 要解密的文字   i   里面就是b kiv  返回解密结果
var data='';
var i={
    b: 'm4l_zJNEx8szYk2EGo6zVQq3lObRE64Rk_T6QvHkbzU~',
    kiv: '4gVyNWeZUSM36Zo4'
}