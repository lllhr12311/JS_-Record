...
!function(e) {
  ...
  0:function(module, exports, __webpack_require__) {
    ...
    "use strict";
	let encrypt=__webpack_require__(0).default;
	var U = Object.fromEntries || function(e) {
	  ...
	  , z = function(e) {
		return null == e ? "" : "string" == typeof e ? e : "undefined" != typeof URLSearchParams && e instanceof URLSearchParams ? e.toString() : l()(e) ? JSON.stringify(e) : ("object" == typeof (t = e) ? null === t : "function" != typeof t) ? String(e) : "";
		var t
	}
	  , H = function(e, t) {
	  ...
	  , V = new RegExp("d_c0=([^;]+)")
	  , q = function() {
		var e = V.exec(document.cookie);
		return e && e[1]
	};
	var jiami=function (e, t, n) {
		var r = n.zse93
		  , i = n.dc0
		  , o = n.xZst81
		  , a = G(e)
	...
	function abc(word){
		...
		var fanhui=h(v(word));
        return "2.0_" + encrypt(encodeURIComponent(fanhui));
	}
	exports.jiami=jiami
	},
})
...
var bbb=aaa(1);
let t = '/api/v4/me?include=ad_type%2Cavailable_message_types%2Cdefault_notifications_count%2Cfollow_notifications_count%2Cvote_thank_notifications_count%2Cmessages_count%2Cemail%2Caccount_status%2Cis_bind_phone'
  , n = {
    "zse93": "101_3_2.0",     //版本号吧
    "dc0": '"ACBecH7xnBSPTkP6NzsSbWGjYYdB3rQneBI=|1646909672"', //cookie里面操作了一下
    "xZst81": null
};
var x_zse_96=bbb.jiami(t, undefined, n).signature;
console.log(x_zse_96);